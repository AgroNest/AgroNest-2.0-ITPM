...
const LabCards = () => {
  ...
  const handleExportCSV = () => {
    ...
    const csvContent = labs
      .map((lab) => Object.values(lab).join(','))
      .join('\n');
  ...
  return (
    <div>
      ...
      >
        <FormControl
          variant="outlined"
          style={{ marginRight: '10px', minWidth: '100px', minHeight: '10px' }}
        >
        ...
        >
          ...
          >
            ...
            {labs.map((lab, index) => (
              <MenuItem key={index} value={lab[filterBy]}>
                {lab[filterBy]}
              </MenuItem>
            ))}
          </Select>
          ...
          {filteredLabs.map((lab, index) => (
            <Card
              ...
              sx={{
                ...
                margin: '25px',
                position: 'relative',
                backgroundImage: `linear-gradient(rgba(0,0,0,0.85), rgba(0,0,0,0.2)), url(${labBackground})`,
              ...
              >
                ...
                >
                  <Button
                    variant="contained"
                    size="small"
                    onClick={() => handleViewClick(lab._id)}
      ...
      <Dialog open={openDialog} onClose={handleDialogClose} fullWidth>
        <DialogTitle sx={{ fontSize: 26, fontWeight: 'bold' }}>
          {selectedLab?.name}
        </DialogTitle>
        <DialogContent
          sx={{ fontSize: 16, fontWeight: 'bold', maxHeight: '200vh' }}
        >
