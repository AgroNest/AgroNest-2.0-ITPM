...
const OrderHistoryPage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`http://localhost:8070/order/history/${farmerId}`)
      .then((response) => {
  ...
  return (
    <Container maxWidth="md" sx={{ marginTop: '120px' }}>
                ...
                <ListItemText
                  ...
                  secondary={
                    <>
                      ...
                      <br />
                      Item Code: {order.itemcode} | Price: Rs. {order.price} |
      ...
      {selectedOrderId && (
        <CookiesBanner onClose={handleCloseBanner} orderId={selectedOrderId} />
      )}
    </Container>
  );
};
