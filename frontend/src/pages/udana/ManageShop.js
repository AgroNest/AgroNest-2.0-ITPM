...
import AddFertilizer from '../../Component/udana/AddFertilizer';
...
const ManageShop = () => {
  ...
  const handleUpdateFertilizer = async (
    ...
    try {
      console.log('Updating fertilizer:', {
        fertilizerId,
        updatedPrice,
        updatedQuantity,
      });
      ...
      const response = await axios.put(
        `http://localhost:8070/dealer/updatefertilizers/${fertilizerId}`,
        {
          price: price,
          quantity: quantity,
        }
  ...
  const handleDeleteProduct = async (fertilizerId) => {
    try {
      ...
      const response = await axios.delete(
        `http://localhost:8070/dealer/deletefertilizer/${fertilizerId}`
      );
    ...
    <div className="container">
      ...
      <div className="content">
            ...
            {fertilizers.map((fertilizer, index) => (
              <div key={index} className="fertilizer-item">
                <div className="image-container">
                  <img
                    src={getFertilizerImage(fertilizer.name)}
                    alt={fertilizer.name}
                  />
                </div>
                <div className="fertilizer-details">
                  ...
                  <Typography
                    ...
                    style={{ color: 'black' }}
                  >
                    <b>Item Code:</b> {fertilizer.itemcode}
                  </Typography>
                  <Typography
                    variant="body1"
                  ...
                  <Typography
                    ...
                    style={{ color: 'black' }}
                  >
                    <b>Quantity:</b> {fertilizer.quantity}
                  </Typography>
                </div>
              </div>
            ))}
        ...
        <div className="section update-listings-section dark-green-bg">
              ...
              <div key={index} className="fertilizer-item">
                ...
                <div className="fertilizer-details">
                  ...
                  <TextField
                    ...
                    onChange={(event) =>
                      handlePriceChange(event, fertilizer._id)
                    }
                    InputProps={{
                  ...
                  <TextField
                    ...
                    className="fertilizer-quantity"
                    value={
                      (updatedQuantity[fertilizer._id] || {}).quantity || ''
                    }
                    onChange={(event) =>
                      handleQuantityChange(event, fertilizer._id)
                    }
                    InputProps={{
                  ...
                  <div className="button-container">
                    ...
                    >
                      ...
                      <Button
                        onClick={() =>
                          handleOpenConfirmationDialog(fertilizer._id)
                        }
                        color="error"
                        sx={{
                          borderRadius: '20px',
          ...
          >
            <DialogTitle>
              Are you sure you want to delete fertilizer?
            </DialogTitle>
            <DialogActions>
              <Button
                onClick={() => handleDeleteProduct(fertilizerToDeleteId)}
                color="error"
              >
                Yes
              </Button>
